...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    discretize_state_weight = [20, 20, 20, 20]  # More balanced state space
    ...
    save_file_path = "/home/hbbeep/FRA503-Deep-Reinforcement-Learning-for-Robotics/CartPole_4.2.0/rl_metrics/Stabilize/Double_Q_Learning/play_metrics_obs20.csv"
    ...
    q_value_file = "qvalue_obs20.json"
